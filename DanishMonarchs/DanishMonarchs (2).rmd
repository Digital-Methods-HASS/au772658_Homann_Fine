...
kings1 <- read.csv(here("/Users/finehomann/Dropbox/Historie/Digitale arkiver og metoder/Danishmonarchs/data/kings.csv"),na="NULL") 

kings2 <- read_csv(here("/Users/finehomann/Dropbox/Historie/Digitale arkiver og metoder/Danishmonarchs/data/kings.csv"),na="NULL") 

kings3 <- read.csv2(here("/Users/finehomann/Dropbox/Historie/Digitale arkiver og metoder/Danishmonarchs/data/kings.csv"),na="NULL") 

kings4 <- read_csv2(here("/Users/finehomann/Dropbox/Historie/Digitale arkiver og metoder/Danishmonarchs/data/kings.csv"),na="NULL") 
...
kings <-  read_csv(here("/Users/finehomann/Dropbox/Historie/Digitale arkiver og metoder/Danishmonarchs/data/kings.csv"),na="NULL") 
...
kings <- kings %>%
  mutate(
    Start_year = as.numeric(as.character(Start_year)),
    End_year = as.numeric(as.character(End_year)),
    duration = End_year - Start_year
  )
class(kings$duration)
...
```{r}
# YOUR CODE
filter(kings,kings$duration>19.58)

count(kings,kings$duration>19.58)
...
```{r}
# YOUR CODE
ggplot(kings, aes(x = (Start_year+End_year)/2, y =duration)) +
  geom_point() +
  geom_smooth() +
  labs(title = "Trend of Reign Duration Over Time",
       x = "midyear",
       y = "duration") +
  theme_bw()
```
