...
knitr::opts_chunk$set(echo = TRUE,
                      message=FALSE)
file.info("/Users/finehomann/Dropbox/Historie/Digitale arkiver og metoder/HomicideHistory-main/EuropeanHomicide_exercise.Rmd")$mtime
```
...
Homicide rate is relative to the number of inhabitants. Homicide number is the total amount of homicides in the country
...
ggplot(data = Western_Europe) + 
  ...
  geom_line()+
  labs(title = "Homicide rate in Europe over long-term",
       y="Homicides rate per 100.000")+
  theme_classic()
...
It fits well with duration of reign rising as homicide rates fall, although it's a less steep rise in the duration of reigns compared to Scandinavian homicide rates

```{r eval = TRUE}
# plotting reign duration of Danish monarchs
kings <- read_csv("/Users/finehomann/Dropbox/Historie/Digitale arkiver og metoder/HomicideHistory-main/data/kings_updated.csv")
kings <- kings%>%
...
ggplot(data = kings) + 
  ...
  geom_smooth()+
  labs(title = "Reign duration for Danish kings",
       x="Year",
       y="Duration")+
  theme_classic()
```
